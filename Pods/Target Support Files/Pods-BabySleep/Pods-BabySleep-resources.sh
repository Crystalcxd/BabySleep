...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/ELCImagePickerController/Classes/ELCImagePicker/Resources/ELCAlbumPickerController.xib"
  install_resource "${PODS_ROOT}/ELCImagePickerController/Classes/ELCImagePicker/Resources/ELCAssetPicker.xib"
  install_resource "${PODS_ROOT}/ELCImagePickerController/Classes/ELCImagePicker/Resources/ELCAssetTablePicker.xib"
  install_resource "${PODS_ROOT}/ELCImagePickerController/Classes/ELCImagePicker/Resources/Overlay.png"
  install_resource "${PODS_ROOT}/ELCImagePickerController/Classes/ELCImagePicker/Resources/Overlay@2x.png"
